package com.example.LifeNext
import com.example.LifeNext.fragment.HabitsFragment
import com.example.LifeNext.fragment.MoodJournalFragment
...
class MainActivity : AppCompatActivity() {
    ...
    private fun showExitConfirmation() {
        androidx.appcompat.app.AlertDialog.Builder(this)
            .setTitle("Exit App")
            .setMessage("Are you sure you want to exit LifeNext?")
